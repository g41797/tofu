...
pub const AmpeVTable = struct {
    ...
    ///
    /// Thread-safe.
    acquire: *const fn (ptr: ?*anyopaque) anyerror!engine.MessageChannelGroup,

    /// Releases a message channel group, stopping communication and freeing associated memory.
    ///
    /// Thread-safe.
    release: *const fn (ptr: ?*anyopaque, mcgimpl: ?*anyopaque) anyerror!void,
};
...
pub const MCGVTable = struct {
    ...
    ///
    /// Thread-safe.
    get: *const fn (ptr: ?*anyopaque, strategy: engine.AllocationStrategy) anyerror!*message.Message,
    ...
    ///
    /// Thread-safe.
    asyncSend: *const fn (ptr: ?*anyopaque, msg: *message.Message) anyerror!message.BinaryHeader,
    ...
    waitReceive: *const fn (ptr: ?*anyopaque, timeout_ns: u64) anyerror!?*message.Message,
